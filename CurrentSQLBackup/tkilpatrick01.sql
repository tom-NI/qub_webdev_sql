...
--
ALTER TABLE `epl_admins`
  MODIFY `AdminID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50019;
...
--
ALTER TABLE `epl_clubs`
  MODIFY `ClubID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `epl_match_edits`
  MODIFY `EditID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
